...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    *settings.borrow_mut() = settings::load();
    ...
    window.set_metadata_first_column_width(settings.borrow().metadata_first_column_width.into());
    window.set_metadata_second_column_width(settings.borrow().metadata_second_column_width.into());
    window.set_metadata_right_column_width(settings.borrow().metadata_right_column_width.into());
